      ...
      {isOpened && (
        <>
          <motion.div
            ...
            className="fixed z-10 inset-0 bg-neutral-800/90 w-full h-[100vh] backdrop-blur-sm"
            key="th-overlay"
            role="dialog"
          ...
          <motion.div
            ...
            className="fixed z-20 top-10 sm:top-1/2 sm:left-1/2 -translate-1/2 w-4/5 bg-[var(--th-bg)] my-auto rounded-lg p-4"
            key="th-select"
          >
            ...
            <div>
              ...
              <div className="mb-6 transition-colors bg-neutral-800/90 p-4 rounded">
                <div className="w-50 sm:w-100 h-50 sm:h-80 bg-[var(--bg)] mx-auto rounded-lg flex flex-col justify-center items-center p-4 gap-2">
